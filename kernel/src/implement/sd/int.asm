...
; º                   Copyright (C) 2023-2024, Joey Qytyku                     º
; ÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹
; º  This file is part of OS/90 and is published under the GNU General Public  º
; º    License version 2. A copy of this license should be included with the   º
; º      source code and can be found at <https://www.gnu.org/licenses/>.      º
